...
class JavaToolchainQueryServiceTest extends Specification {
    ...
    {
        new JavaToolchainQueryService(registry, detector, TestFiles.fileFactory(), provisioningService, createProviderFactory(), TestUtil.objectFactory(), createEventEmitter(), currentJvm)
    }
