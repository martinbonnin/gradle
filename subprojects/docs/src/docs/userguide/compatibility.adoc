...
[[kotlin]]
== Kotlin
Gradle is tested with Kotlin 1.6.10 through 1.8.0.
Beta and RC versions may or may not work.

Gradle plugins written in Kotlin target Kotlin 1.5 for compatibility with Gradle and Kotlin DSL build scripts, even though the embedded Kotlin runtime is Kotlin 1.8.
...
== Android
Gradle is tested with Android Gradle Plugin 7.3 and 7.4.
